...
class MakeScheduleReborn: 
	def init(self,outsche):
		self.outsche=outsche
...
Job ID: 6
    ...
    Scan Condition: STARTPHI ENDPHI STEPPHI   # from to step [deg]
    ...
    Advanced npoint: ANPOINTS # [mm]
    Advanced step: ADLENGTH # [mm]
    Advanced interval: 1 # [frames]
    Advanced gonio coordinates 1: GX1 GY1 GZ1 # id, x, y, z
    Advanced gonio coordinates 2: GX2 GY2 GZ2 # id, x, y, z
